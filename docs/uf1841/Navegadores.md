...
![bg 90%](./assets/the-only-guide-on-the-difference-between-web-server-web-browser-you-will-ever-need.jpg)
...
![bg](./assets/Partes-de-la-direccion-web.jpg)

---

![bg](./assets/estructura-url.png)
...
![bg](./assets/maxresdefault.jpg)

---

![bg](./assets/1_-_Cover.max-1200x1200.png)
