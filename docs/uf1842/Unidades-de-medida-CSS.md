...
Aínda que sexan as máis axeitadas **para imprimir**, xa que os medios impresos adoitan medirse nesas unidades. As medidas absolutas,  **non son nada recomendables para a pantalla**.<!-- .element: class="fragment highlight-current-red" -->
